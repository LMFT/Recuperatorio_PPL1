...
/** \brief Gets the max value in a int array
 *
 * \param array int* Array
 * \param size int amount of elements
 * \param max int* Output pointer for the max value
 * \return int -1 if pointers are NULL
                0 if ok
 *
 */
int Comparison_GetMax(int* array, int size, int* max);
/** \brief Gets the max value in a float array
 *
 * \param array float* Array
 * \param size int amount of elements
 * \param max float* Output pointer for the max value
 * \return int -1 if pointers are NULL
                0 if ok
 *
 */
